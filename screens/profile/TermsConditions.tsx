        ...
        <ScrollView>
          <View style={styles.applicationContainer}>
            ...
            <Text style={styles.TandCText}>
              Welcome to https://complyify.in/{'\n'} {'\n'}
              These terms and conditions outline the rules and regulations for
              the use of True Technologies Website, located at
              https://complyify.in/ {'\n'} {'\n'}
              By accessing this website, we assume you accept these terms and
              conditions. Do not continue to use https://complyify.in/ if you do
            ...
            <Text style={styles.tcHead}>Cookies</Text>
            <Text style={styles.TandCText}>
              We employ the use of cookies. By accessing https://complyify.in/,
              you agreed to use cookies in agreement with the True Technologies
              Privacy Policy.
            ...
            <Text style={styles.tcHead}>License</Text>
            <Text style={styles.TandCText}>
              Unless otherwise stated, True Technologies and/or its licensors
              own the intellectual property rights for all material on
              https://complyify.in/. All intellectual property rights are
              reserved. You may access this from https://complyify.in/ for your
              own personal use subjected to restrictions set in these terms and
              conditions.
              {'\n'} {'\n'}You must not:
              {'\n'} {'\n'}
              Republish material from https://complyify.in/{'\n'} {'\n'}
              Sell, rent or sub-license material from https://complyify.in/
              {'\n'} {'\n'}
              Reproduce, duplicate or copy material from https://complyify.in/
              {'\n'} {'\n'}
              Redistribute content from https://complyify.in/{'\n'} {'\n'}
              ...
              Complyify does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of True Technologies, its agents and/or
              ...
              applicable laws, Complyify shall not be liable for the Comments or
              ...
              Complyify reserves the right to monitor all Comments and to remove
              any Comments which can be considered inappropriate, offensive or
              causes breach of these Terms and Conditions.
            </Text>
            <Text style={styles.tcHead}>You warrant and represent that:</Text>
            <Text style={styles.TandCText}>
              ...
              {'\n'}
              You hereby grant True Technologies a non-exclusive license to use,
              ...
              Complyify; and (d) the link is in the context of general resource
              information.
              {'\n'}
              {'\n'}
              {'\n'}
              ...
              by sending an e-mail to Complyify. Please include your name, your
              ...
              linking party's site.
              {'\n'}
              No use of Complyify’ logo or other artwork will be allowed for
              linking absent a trademark license agreement.
              {'\n'}
            </Text>
            <Text style={styles.tcHead}>iFrames</Text>
            <Text style={styles.TandCText}>
              Without prior approval and written permission, you may not create
              frames around our Webpages that alter in any way the visual
              presentation or appearance of our Website.
            </Text>
            <Text style={styles.tcHead}>Content Liability</Text>
            <Text style={styles.TandCText}>
            ...
            <Text style={styles.tcHead}>Reservation of Rights</Text>
            <Text style={styles.TandCText}>
            ...
            <Text style={styles.tcHead}>Removal of links from our website</Text>
            <Text style={styles.TandCText}>
            ...
            <Text style={styles.tcHead}>Disclaimer</Text>
            <Text style={styles.TandCText}>
